...
const expense3 = store.dispatch(addExpense({ description: 'Bagel', amount: 2, createdAt: 150 }));
const expense4 = store.dispatch(addExpense({ description: 'Eggs', amount: 500, createdAt: 2000 }));
